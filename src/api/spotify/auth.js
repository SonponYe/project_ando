...
export const getSpotifyAuthUrl = () => {
  ...
  const authUrl = `https://accounts.spotify.com/authorize?client_id=${CLIENT_ID}&response_type=token&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&scope=${scopeParam}`;
  return authUrl;
};
